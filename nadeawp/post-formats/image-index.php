					<?php if (has_post_thumbnail( $post->ID ) ):?>									
									...
									<div class="item animation" data-animation="animation-fade-in-up">		
										...
										<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
							                ...
							                <?php if (has_post_thumbnail( $post->ID ) ):
				                                  $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'blog-single' );?><a href="<?php the_permalink();?>">
												<img src="<?php echo esc_url($image[0]);?>" alt="" class="img-responsive"/></a>
											<?php endif;?>	
											</div>
