...
$wr_class_layout =  "";
if($wr_section_layout == "section_full_width"){
	$wr_class_layout =  "wr-section-full-width";
}
 else if ($wr_section_layout == "section_grid"){
	$wr_class_layout =  "container";
}
...
if($row_type == 'row') {
    ...
    $output .=' class="full-width-section '.$wr_section_class.'"';
	...
	if($wr_section_height != "" || $wr_background_color != "" || $wr_background_img != "" || $wr_background_parallax != "" || $wr_padding_top != "" || $wr_padding_bottom != "" || $wr_margin_top != "" || $wr_margin_bottom != ""){
			$output .= " style='";
				...
				if($wr_background_img != ""){
					$output .="background-image:url(".$wr_back_image[0].");";
				}
	...
	$output.=">";	
		...
		$output .='<div class="'.$wr_class_layout.' section-wrapper">';
